...
namespace Job_Portal_API.Context
{
    public class BloodDonationAppContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-QL1TE6V\\SQLEXPRESS;Integrated Security=true;Initial Catalog=BloodDonationApp;");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BloodDonation>()
                .HasOne(a => a.BloodStock)
                .WithMany(j => j.BloodDonations)
                .HasForeignKey(a => a.ID)
                .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<BloodStock>()
                .HasMany(j => j.DonorBloods)
                .WithOne(js => js.BloodStocks)
                .HasForeignKey(js => js.ID);
