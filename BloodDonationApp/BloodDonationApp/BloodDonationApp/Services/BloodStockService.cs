...
namespace Job_Portal_API.Services
{
 ...
 {    // Validate and convert BloodType
     ...
     catch (BloodStockNotFoundException e)
     {
        ...
        Task<BloodStockResponseDTO> IBloodStock.AddBloodStockAsync(BloodStockDTO BloodStockDto)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<BloodStockResponseDTO>> IBloodStock.GetAllBloodStocksAsync()
        {
            throw new NotImplementedException();
        }

        Task<BloodStockResponseDTO> IBloodStock.GetBloodStockByIdAsync(int id)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<BloodStockResponseDTO>> IBloodStock.GetBloodStocksByDonorIdAsync(int donorId)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<BloodStockResponseDTO>> IBloodStock.GetBloodStocksByLocationAsync(string location)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<BloodStockResponseDTO>> IBloodStock.GetBloodStocksBySalaryAsync(double sRange, double eRange)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<BloodStockResponseDTO>> IBloodStock.GetBloodStocksBystatusAsync(string status)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<BloodStockResponseDTO>> IBloodStock.GetBloodStocksByTitleAsync(string title)
        {
            throw new NotImplementedException();
        }
    }
