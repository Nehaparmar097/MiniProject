...
namespace BloodDonationApp.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPost("RecipientLogin")]
        [ProducesResponseType(typeof(LoginReturnDTO), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ErrorModel), StatusCodes.Status401Unauthorized)]
        public async Task<ActionResult<LoginReturnDTO>> RecipientLogin(UserLoginDTO userLoginDTO)
        {
            try
            {
                var result = await _userService.RecipientLogin(userLoginDTO);
        ...
        public async Task<ActionResult<RegisterReturnDTO>> RecipientRegister(UserRegisterDTO userRegisterDTO)
        {
            try
            {
                var result = await _userService.RecipientRegister(userRegisterDTO);
        ...
        [ProducesResponseType(typeof(RegisterReturnDTO), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ErrorModel), StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<RegisterReturnDTO>> DonorRegister(UserRegisterDTO userRegisterDTO)
        {
            try
            {
                var result = await _userService.DonorRegister(userRegisterDTO);
